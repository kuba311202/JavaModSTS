...
import static Postac.Postac.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {


    public static final String ID = Postac.makeID("IdentityCrisisEvent");
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("PostacResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
