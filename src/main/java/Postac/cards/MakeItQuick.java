...
public class MakeItQuick extends AbstractGreyCard {


    public static final String ID = Postac.makeID(MakeItQuick.class.getSimpleName());
    public static final String IMG = makeCardPath("MakeItQuick.png");//
    ...
    public MakeItQuick(String id, String img, String name, int cost, String description, CardType type, CardColor color, CardRarity rarity, CardTarget target) {
        super(id, img, cost, type, color, rarity, target);
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new DiscardAction(p,p,10,true));
        this.addToBot(new DrawCardAction(p,magicNumber));
        if(isFlanked(this)){
            this.addToBot(new MakeItQuickAction());
