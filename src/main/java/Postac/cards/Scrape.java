...
public class Scrape extends AbstractGreyCard {


    public static final String ID = Postac.makeID(Scrape.class.getSimpleName());
    public static final String IMG = makeCardPath("Scrape.png");//
    ...
    public Scrape(String id, String img, String name, int cost, String description, CardType type, CardColor color, CardRarity rarity, CardTarget target) {
        super(id, img, cost, type, color, rarity, target);
    }
