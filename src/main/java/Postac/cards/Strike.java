...
public class Strike extends AbstractDynamicCard {
    ...
    public static final String ID = Postac.makeID(Strike.class.getSimpleName());
    ...
    public Strike(String id, String img, String name, int cost, String description, CardType type, CardColor color, CardRarity rarity, CardTarget target) {
        super(id, img, cost, type, color, rarity, target);
    }
